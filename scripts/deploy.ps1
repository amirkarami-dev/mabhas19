...
Remote "cd $AppPath && rm -rf src web packages tests mobile docs 'Directory.Build.props' 'Directory.Packages.props' *.slnx package.json package-lock.json && tar -xzf /tmp/mabhas19-src.tar.gz -C $AppPath && rm -f /tmp/mabhas19-src.tar.gz"
